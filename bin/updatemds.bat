...
set _LAST_MODIFIED_OLD=michelou/)/March 2025
set _LAST_MODIFIED_NEW=michelou/)/June 2025

set _LAST_DOWNLOAD_OLD=(\*March 2025\*)
set _LAST_DOWNLOAD_NEW=(*June 2025*)

@rem to be transformed into -not -path "./<dirname>/*"
set _EXCLUDE_TOPDIRS=akka bin docs
