...
@rem https://mvnrepository.com/artifact/org.apache.pekko/pekko-actor-typed
call :add_jar "org.apache.pekko" "pekko-actor-typed_%__SCALA_BINARY_VERSION%" "%__PEKKO_VERSION%"

@rem https://mvnrepository.com/artifact/org.apache.pekko/pekko-slf4j
call :add_jar "org.apache.pekko" "pekko-slf4j_%__SCALA_BINARY_VERSION%" "%__PEKKO_VERSION%"
...
@rem call :add_jar "org.projectlombok" "lombok" "%__LOMBOK_VERSION%"

@rem test scope

@rem https://mvnrepository.com/artifact/org.apache.pekko/pekko-testkit
call :add_jar "org.apache.pekko" "pekko-testkit_%__SCALA_BINARY_VERSION%" "%__PEKKO_VERSION%"

@rem https://mvnrepository.com/artifact/com.typesafe.akka/akka-actor-testkit-typed
call :add_jar "org.apache.pekko" "pekko-actor-testkit-typed_%__SCALA_BINARY_VERSION%" "%__PEKKO_VERSION%"
